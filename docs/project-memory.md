...
Останнє оновлення: травень 2026 року, підготовка PR з фізики.
...
| Physics   | `devin/content-physics`   | TBD                                                     | In progress                                             |
...
| #   | Пункт                              | Згода      | Статус                                          |
| --- | ---------------------------------- | ---------- | ----------------------------------------------- |
| 6   | 75 фактів (15 на предмет)          | ✓ (більше) | 4/5 батчі merged, фізика в роботі               |
