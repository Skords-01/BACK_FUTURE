...
Останнє оновлення: травень 2026 року, після PR #5 (географія).
...
| History   | —                         | —                                                     | **Pending** (найделікатніший — потребує явної згоди)    |
| Physics   | —                         | —                                                     | Pending                                                 |
...
| Історичний батч                           | Очікує **явної згоди** користувача через делікатність теми.          |
